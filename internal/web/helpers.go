...
// BuildDataSourceSummary creates a DataSourceSummary with calculated percentage.
func BuildDataSourceSummary(dsType string, title string, total int, indexed int) DataSourceSummary {
	percent := 0.0
	if total > 0 {
